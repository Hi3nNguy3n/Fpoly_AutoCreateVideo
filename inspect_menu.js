...
async function inspectMenu() {
    ...
    // Click vào Pill cài đặt
    console.log("Clicking setting pill at 1137, 1022...");
    await page.mouse.click(1137, 1022);
    await new Promise(r => setTimeout(r, 2000));

    // Lấy thông tin các button mới xuất hiện (menu)
    ...
    await page.screenshot({ path: 'menu_inspect.png' });
    await browser.close();
}
